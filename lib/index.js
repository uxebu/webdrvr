/**
 * @fileoverview WebDriver setup made available via require('webdriver') once package is
 * installed.
 */
...
var getWebdriverEnv = function(env) {
  ...
  var SELENIUM_VERSION = '2.35.0';
  var CHROMEDRIVER_VERSION = '2.2';
  var IEDRIVER_VERSION = '2.35.1';
...
module.exports = getWebdriverEnv(process);
module.exports.getWebdriverEnv = getWebdriverEnv;
